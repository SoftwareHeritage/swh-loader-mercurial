...
# TODO: This document mirrors swh-loader-git/swh/loader/git/base.py exactly
# (minus the logger names and this comment)
# Please merge the files at a shared level at next opportunity.
...
def retry_loading(error):
    ...
    logger = logging.getLogger('swh.loader.hg.BulkLoader')
